          ...
          <div className="w-96 font-bold border-2 border-gray-400 p-10 max-md:w-80 max-sm:w-60">
              <h1 className="text-xl font-bold leading-tight  text-black text-center">
                 تسجيل الدخول
                  ...
                  <p className="text-sm font-light text-right mt-3">
                     ليس لديك حساب <a href="/register" className="font-medium text-primary-600 hover:underline dark:text-primary-500">اضافة حساب</a>
                  </p>
