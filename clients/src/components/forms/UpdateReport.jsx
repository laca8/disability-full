...
<div className='border-2 border-gray-400 mt-2'> 
     ...
     <div className='border-2 border-gray-400 mt-2 '> 
      ...
      <div className='flex flex-col w-auto p-1'>
         <label>الاسم</label>
         <input disabled={imp}  value={connName} onChange={(e)=>setConnName(e.target.value)}  className={`bg-gray-100 p-1 w-full rounded-sm border-2 border-gray-400`} type='text' placeholder='ادخل الاسم' />
       </div>
       <div className='flex flex-col  w-auto p-1'>
     ...
     <div className='border-2 border-gray-400  mt-2'> 
      ...
      <div className='flex flex-col w-auto  p-1'>
       ...
       <div className='flex flex-col w-auto p-1'>
         ...
         <input value={age} onChange={(e)=>setAge(e.target.value)} className='bg-gray-100 p-1 rounded-sm border-2 border-gray-400'  type='text' placeholder='ادخل تاريخ الميلاد ' />
       </div>
       <div className='flex flex-col  w-auto p-1'>
       <label>المحافظة </label>
       ...
       <div className='flex flex-col w-auto p-1'>
         <label>الرقم القومي</label>
         <input value={ids} onChange={(e)=>setIds(e.target.value)} className='bg-gray-100 p-1 rounded-sm border-2 border-gray-400'  />
       </div>
      </div>
...
<input value={finSupport} onChange={(e)=>setFinSupport(e.target.value)} className='bg-gray-100 p-1 rounded-sm border-2 border-gray-400'  />
 ...
 <button className={`bg-gray-400 p-1 rounded-sm text-black hover:scale-90  ${ imp && 'scale-90'} `} disabled={imp == true} onClick={()=>handleImp()}>تنفيذ البلاغ </button>
